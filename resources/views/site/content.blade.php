            ...
            <div class="inner_section">
              <div class="row">
                <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right"><img
                          src="{{ asset('assets/img/' . $page->images) }}" class="img-circle delay-03s animated wow zoomIn"
                          alt=""></div>
    ...
    <div class="container">
      ...
      <div class="service_wrapper">
        @foreach ($services as $k=>$service)
            ...
            @endif
              <div class="col-lg-4 {{ ($k % 3 > 0) ? 'border:eft' : ' ' }} {{ ($k > 2) ? 'mrgTop' : ''  }}">
                <div class="service_block">
                  <div class="service_icon delay-03s animated wow  zoomIn"><span><i class="fa {{ $service->icon }}"></i></span>
                  </div>
      ...
      @if (isset($tags) && is_object($tags))
        <div id="filters" class="sixteen columns">
          <ul class="clearfix">
            ...
            @foreach ($tags as $tag)
              <li>
                <a class="" href="#" data-filter=".{{ $tag["filter"] }}">
                  <h5>{{ $tag["filter"] }}</h5>
                </a>
              </li>
            @endforeach
